...
tableau_technology_d = {}; tableau_projects_d = {}; networkx_txt = [] ; tableau_address_cou = {}; tableau_address_cty = {}
...
def tableau_technology(techList):
    global tableau_technology_d
    for tech in techList:
        tableau_technology_d.setdefault(tech,0)
        tableau_technology_d[tech]+=1
...
def standardize_github(dataList):
    ...
    for jsonObj in dataList:
        ...
        tableau_technology( map(string.lower, jsonObj['technology']) )
...
def standardize_stackoverflow(dataList):
    ...
    for jsonObj in dataList:
        ...
        tableau_technology( map(string.lower, jsonObj['Skills'] ) )
